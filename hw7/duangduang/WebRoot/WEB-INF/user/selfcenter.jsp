  ...
  <div class="container_12">
    ...
    <header id="branding">
      ...
      <div class="grid_6">
        <ul id="cart_nav">
          <li>
            <a class="cart_li" href="shoppingcart.html">购物车 <span>￥0.00</span></a>
            <ul class="cart_cont">
  ...
  <div id="block_nav_primary">
    <div class="container_12">
      <div class="grid_12">
        <nav class="primary">
          <ul>
            <li class="curent"><a href="selfcenter.html">我的DuangDuang</a></li>
            <li><a href="selfcenter.html">账户设置</a>
              <ul class="sub">
                <li><a href="${pageContext.request.contextPath}/pwdchange_pwdchange.action">修改登录密码</a></li>
                <li><a href="${pageContext.request.contextPath}/selfchange_selfchange.action">修改个人信息</a></li>
              </ul>
            </li>
          </ul>
        </nav><!-- .primary -->
	      ...
	      <aside id="categories_nav">
		     ...
		     <nav class="left_menu">
			    <ul>
				   ...
				   <li><a href="${pageContext.request.contextPath}/dealcenter_dealcenter.action">已买到的宝贝<span>(33)</span></a></li>
			    </ul>
		     </nav><!-- .left_menu -->
