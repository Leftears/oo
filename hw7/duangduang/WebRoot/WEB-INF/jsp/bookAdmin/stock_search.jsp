       ...
       <div id="content">
         ...
         <div id="sidebar" class="grid_3">
	      <aside id="categories_nav">
              <h3>出入库查询</h3>
              <form id="searchCin" action="Stock_searchData" method="post">
                <table>
                   <tr>
                     <td>请输入要查询的图书编号:<td>
                     <td><input type="text" name="stocksearch" /></td>
                  </tr>
                  <tr>
                     <td> <input type="submit" id="stocksearchSure" value="确定" style="margin:30px 0;width:50px;" /></td>
                     <td> <input type="reset" id="stocksearchCancel" value="取消" style="margin:30px 0;width:50px;"/></td>
                  </tr>
                </table>
	          </form>
		...
		<div id="grid_66"  style="width:900px;float:left;">
			 <!-- 将查询的信息返回在该界面，支持精确查询和模糊查询-->
           <form id="searchstockPrint">
             <table>
                <tr>
                   <td>图书编号</td>
                   <td>库存量</td>
