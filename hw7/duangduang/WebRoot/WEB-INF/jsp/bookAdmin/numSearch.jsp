       ...
       <div id="content">
         ...
         <div id="sidebar" class="grid_3">
	      <aside id="categories_nav">
              <h3>查询</h3>
              <form id="searchCin" action="BookNumsearch" method="post">
                <table>
                   <tr>
                     <td>请输入要查询的图书编号:<td>
                  ...
                  <tr>
                     <td> <input type="submit" name="numsearchSure" value="确定" style="margin:30px 0;width:50px;" /></td>
                     <td> <input type="reset" name="numsearchCancel" value="取消" style="margin:30px 0;width:50px;"/></td>
                  </tr>
                </table>
	          </form>
