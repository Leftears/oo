      ...
      <div class="grid_12">
        <nav class="primary">
          <ul>
            ...
            <li class="curent"><a href="xcatalog.html">小说</a></li>
  ...
  <div class="container_12">
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="index.html">主页</a><span>&#8250;</span><span class="current">小说</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
       ...
       <div id="content" class="grid_9">
	      ...
	      <div class="grid_product">
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x1.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">阿弥陀佛么么哒</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥37.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x2.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">汉家天下</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x3.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">呼啸山庄</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x4.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">如果这就是爱情</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x5.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">十宗罪：中国十大恐怖凶杀案</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x6.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">最漫长的那一夜</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥31.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x7.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">篡改的命</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/top.png" alt="Top"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x8.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">可爱的她</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥40.30</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x9.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">光明王</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥40.30</div>
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x10.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">决战王妃</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x11.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">我的漂亮朋友</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/x12.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">纸牌屋</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥77.60</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
