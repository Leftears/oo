  ...
  <div class="container_12">
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="index.html">主页</a><span>&#8250;</span><span class="current">搜索</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
  ...
  <section id="main">
    <div class="container_12">
       ...
       <div id="content" class="grid_9">
	      <h1 class="page_title">您搜索的结果如下</h1>
	      
	      <c:forEach items="${list1}" var="book">
	      <div class="grid_3 product">
			    <img class="sale" src="images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="images/${book.src}" alt="" title="" /></a>
			    </div><!-- .prev -->
