...
<body>
  <div class="container_12">
    <div id="top">
      ...
      <div class="grid_6">
        <div class="welcome">
          欢迎进入DuangDuang网上书城，请&nbsp&nbsp<a href="${pageContext.request.contextPath}/beginlogin_beginlogin.action">登录</a><a href="${pageContext.request.contextPath}/beginregister_beginregister.action">免费注册</a>.
        </div><!-- .welcome -->
      </div><!-- .grid_6 -->
    </div><!-- #top -->
    ...
    <header id="branding">
      ...
      <div class="grid_6">
        <ul id="cart_nav">
	      ...
	      <li class="no_border">
		<a href="shopping_cart.html" class="view_cart">查看购物车吧</a>
      ...
      <div class="grid_12">
        <nav class="primary">
          <ul>
            ...
            <li><a href="catalog_grid.html">图书</a></li>
