      ...
      <div class="grid_12">
        <nav class="primary">
          <ul>
	        ...
	        <li class="curent"><a href="qcatalog.html">其他</a></li>
          </ul>
        </nav><!-- .primary -->
      </div><!-- .grid_12 -->
    </div><!-- .container_12 -->
  ...
  <div class="container_12">
    <div class="grid_12">
       <div class="breadcrumbs">
	      <a href="index.html">主页</a><span>&#8250;</span><span class="current">其他</span>
       </div><!-- .breadcrumbs -->
    </div><!-- .grid_12 -->
  </div><!-- .container_12 -->
	      ...
	      <aside id="categories_nav">
		     ...
		     <nav class="left_menu">
			    <ul>   <!--点击后进入图书展示页面 -->
                  ...
                  <li><a href="scatalog.html">生活</a></li>
                  <li><a href="kcatalog.html">科技</a></li>
	              <li class="curent"><a class="last"href="qcatalog.html">其他</a></li>
			    </ul>
		     </nav><!-- .left_menu -->
       ...
       <div id="content" class="grid_9">
	      ...
	      <div class="grid_product">
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q1.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">呼吸之间</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥35.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q2.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">美学散步</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q3.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">素书</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥35.00</div>
		     ...
		     <div class="grid_3 product">
			    ...
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q4.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">谈美</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q5.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">学佛三书</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥18.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q6.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">给你一个团队，你能怎么管</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">$47.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q8.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">互联网商业思维</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥22.50</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/top.png" alt="Top"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q9.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">孙正义：未来的机遇在哪里</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥25.20</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q10.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">我的成功不是偶然马云</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥14.00</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q11.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">移动商业革命</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥29.40</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/sale.png" alt="Sale"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q12.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">转型之战</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
						 <div class="price_new">￥27.40</div>
					  </div>
				   </div>
				   <a href="#" class="obn"></a>
				   <a href="#" class="like"></a>
		     ...
		     <div class="grid_3 product">
			    <img class="sale" src="images/new.png" alt="New"/>
			    <div class="prev">
				   <a href="product_page.html"><img src="img/q13.jpg" alt="" title="" /></a>
			    </div><!-- .prev -->
			    <h3 class="title">互联网思维</h3>
			    <div class="cart">
				   <div class="price">
					  <div class="vert">
