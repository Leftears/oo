...
<body>
  ...
  <div class="container_12">
	<div class="grid_12" style="margin:40px 0">
		<h5>请输入要查找的订单账号：</h5>
		 <form id="searchOrders" action="OrderSearchPart" method="post">
		 <table>
		  <tr>
          <input type="text" name="search" class="entry_form" placeholder="搜索订单..."/>
          </tr>
          <tr>
            <td><input type="submit" name="delsure" value="确定" style="margin:30px 0px;width:80px;height:50px"/> </td>
            <td><input type="reset" name="delCancel" value="取消" style="margin:30px 0px;width:50px;border:display;background:#2ab4c4;box-shadow:0 0 2px #2ab4c4;width:80px;height:50px"/></td>
          </tr>
         </table>
	</form>
	</div>
