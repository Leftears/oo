       ...
       <div id="content">
         ...
         <div id="sidebar" class="grid_3">
	      <aside id="categories_nav">
              <h3>密码修改</h3>
              <form id="passwordChange" action="PasswordChangeData" method="post"> 
              <table>
                 <tr>
                    <td>新密码：</td>
                    <td><input type="text" name="change_pwd" /></td>
                 </tr>
                 <tr>
                    <td>确认密码:</td>
                    <td><input type="text" name="sure_pwd"/></td>
                 </tr>
                 <tr>
                     <td>
                        <input type="submit" id="pwdSure" value="确定" 
                            style="width:50px"/>
                     </td>
                     <td>
                        <input type="reset" id="pwdCancel" value="取消"
                            style="width:50px"/>
                     </td>
                 </tr>
              </table>
		...
		<div class="grid_66"  style="width:600px;float:left">
		 ...
		 if("密码修改成功".equals(sstr)){
		 	%><span style="color:red"><%=sstr %></span><% 
		 }
		  %>
		    <%
		 String ssstr= (String)request.getAttribute("message2");
		 if("密码修改失败，请重新修改".equals(ssstr)){
		 	%><span style="color:red"><%=ssstr %></span><% 
		 }
		  %>
